...
//  //Sends and stops signal with delay of 3 seconds
  voltIncrease(3000);
}
...
//}
//
////Used to send signal to a higher voltage cucuit
////PARAMETER: Provides dynamic delay time.
void voltIncrease (int delayTime){
  //Sends signal to curcuit
    digitalWrite(optoIso, HIGH);
  delay(delayTime);
  //Stops signal to curcuit
    digitalWrite(optoIso, LOW);
}
//
//
//

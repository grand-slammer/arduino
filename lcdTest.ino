...
void setup() {
  ...
  //Initialize display
  Init_1621();
  //Initialize display all on
  HT1621_all_on(16); 
  delay(1000);
  //Initialize display all off
  HT1621_all_off(16);
  delay(1000);
...
void loop() {
 ...
 HT1621_all_off(16);
 delay(1000);
 Write_1621(8,num[5]); //5
 delay(1000);
 HT1621_all_off(16);
 delay(1000);
 Write_1621(6,num[5]); //5
 delay(1000);
 HT1621_all_off(16);
 delay(1000);
 Write_1621(4,num[5]); //5
 delay(1000);
 HT1621_all_off(16);
 delay(1000);
 Write_1621(2,num[5]); //5
 delay(1000);
 HT1621_all_off(16);
 delay(1000);
 Write_1621(0,num[5]); //5
 delay(1000);
 HT1621_all_off(16);
 delay(1000);
}
